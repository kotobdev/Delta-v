...
using Content.Shared.Damage.Components; // DeltaV
...
public sealed class EmbedPassiveDamageSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        //SubscribeLocalEvent<EmbedPassiveDamageComponent, DamageOtherOnHitStartupEvent>(OnDamageOtherOnHitStartup); // DeltaV - unneeded
        //SubscribeLocalEvent<ItemToggleEmbedPassiveDamageComponent, ItemToggleDamageOtherOnHitStartupEvent>(OnItemToggleStartup); // DeltaV - unneeded
        SubscribeLocalEvent<EmbedPassiveDamageComponent, EmbedEvent>(OnEmbed);
        SubscribeLocalEvent<EmbedPassiveDamageComponent, EmbedDetachEvent>(OnRemoveEmbed); // DeltaV - use EmbedDetachEvent instead of RemoveEmbedEvent
        //SubscribeLocalEvent<EmbedPassiveDamageComponent, ItemToggledEvent>(OnItemToggle); // DeltaV - unneeded
    ...
    private void OnEmbed(EntityUid uid, EmbedPassiveDamageComponent component, EmbedEvent args)
    {
        ...
        //component.EmbeddedBodyPart = args.BodyPart; // DeltaV - no bodypart
    ...
    private void OnRemoveEmbed(EntityUid uid, EmbedPassiveDamageComponent component, EmbedDetachEvent args) // DeltaV - use EmbedDetachEvent instead of RemoveEmbedEvent
    {
    ...
    public override void Update(float frameTime)
    {
        ...
        foreach (var ent in _activeEmbeds)
        {
            ...
            _damageable.TryChangeDamage(comp.Embedded.Value, comp.Damage, false, false); // DeltaV - restructure to work with modern wizden
        }
    }
}
